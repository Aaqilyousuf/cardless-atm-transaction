      ...
      <div className="bg-white p-12 md:p-20 rounded-lg flex flex-col gap-5 items-center shadow-lg ">
        ...
        <form className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              type="number"
              class="[&::-webkit-inner-spin-button]:appearance-none [appearance:textfield]  outline-none px-2 py-1 rounded-lg bg-transparent w-full border-2 border-gray-100 focus:border-blue-500"
              id="cardno"
